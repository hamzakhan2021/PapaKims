...
<head>
  ...
  canvas {
    ...
    border: 3px solid #13214e !important;
    box-shadow: 3px 4px #e18a99, 3px 4px #e18a99 inset !important;
  }
  .game-over{
    position: absolute;
    left: 50%;
...
function loop() {
	if(death){
		/*
		var _continue = confirm('Your score was ' + score + '\n Do you want to continue?');
		if(_continue){
			death = false;
			score = 0;
		}else{
